        ...
        <div class="card__content">
            <div class="card__content--header">
                ...
                <div>
                    ...
                    <input id="due_date" placeholder="dd-mm-yyyy" type="date" class="input" v-model="form.due_date">
                </div>
                <div>
        ...
        <div class="modal__content">
            ...
            <div class="modal__items">
                <ul style="list-style:none">
                        <li v-for="(item, i) in listproducts" :key="item.id" style="display:grid;grid-template-columns:30px 350px 15px;align-items:center;padding-bottom">
                            <p>{{i+1}}</p>
